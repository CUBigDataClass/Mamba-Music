...
class Signin extends React.Component {
  ...
  onSubmitSignIn = () => {
    fetch('https://powerful-thicket-36340.herokuapp.com/signin', {
      method: 'post',
          ...
          <div className="measure">
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
              ...
              <div className="mt3">
                ...
                <input
                className="pa2 input-reset ba b--white-40 bg-transparent hover-bg-black hover-black w-100"
                type="email"
                name="email-address"
                id="email-address"
                style={{color: "white"}}
              ...
              <div className="mv3">
                ...
                <input
                className="b pa2 input-reset ba b--white-40 white bg-transparent hover-bg-black hover-black w-100"
                type="password"
                name="password"
                id="password"
                style={{color: "white"}}
